...
const Results = ({
  ...
  return (
    <div className="text-center">
      ...
      <button className="w-full bg-yellow-600 text-white rounded-2xl p-2 mt-6 cursor-pointer hover:bg-yellow-700 transition-transform duration-200 hover:scale-105" onClick={handleReset}>Play again</button>
    </div>
  );
};
